...
main(int argc, char *argv[])
{
    ...
    //O primeiro argumento (argv[1]) é a porta onde o servidor aguardará por conexões     
    if (argc != 2)
    {
   ...
   //Define a qual endereço IP e porta o servidor estará ligado. IP = INADDDR_ANY -> faz com que o servidor se ligue em todos os endereços IP    
